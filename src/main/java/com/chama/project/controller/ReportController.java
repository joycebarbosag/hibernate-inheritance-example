...
import com.chama.project.service.ReportService;
...
public class ReportController {
    ...
    @PutMapping("/updateReportStatusOrFire/{id}")
    public ResponseEntity<ReportModel> updateReport(@PathVariable Long id,
                                                    @RequestParam String isFire,
                                                    @RequestParam String ativo) {
        ReportModel updatedReport = reportService.updateReportStatusOrFire(id, isFire, ativo);
